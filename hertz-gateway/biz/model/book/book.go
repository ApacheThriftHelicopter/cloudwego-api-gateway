...
type QueryBookResp struct {
	...
	Author  string `thrift:"Author,3" form:"Author" json:"Author" query:"Author"`
...
func (p *QueryBookResp) GetContent() (v string) {
	return p.Content
}
...
type InsertBookReq struct {
	...
	Author string `thrift:"Author,3" form:"author" json:"Author"`
}
...
type BookSvcQueryBookResult struct {
	Success *QueryBookResp `thrift:"success,0,optional"`
}
...
type BookSvcInsertBookArgs struct {
	Req *InsertBookReq `thrift:"req,1"`
}
...
type BookSvcInsertBookResult struct {
	Success *InsertBookResp `thrift:"success,0,optional"`
}
