...
func (p *CreateBookRequest) Field2DeepEqual(src int64) bool {
...
func (p *DeleteNoteRequest) GetBookId() (v int64) {
	return p.BookId
}
...
func (p *DeleteNoteRequest) SetBookId(val int64) {
	p.BookId = val
}
...
type MGetBookRequest struct {
	BookIds []int64 `thrift:"book_ids,2" frugal:"2,default,list<i64>" json:"book_ids"`
}
...
func (p *MGetBookRequest) ReadField2(iprot thrift.TProtocol) error {
...
func (p *MGetBookRequest) writeField2(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("book_ids", thrift.LIST, 2); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *MGetBookRequest) DeepEqual(ano *MGetBookRequest) bool {
	...
	if !p.Field2DeepEqual(ano.BookIds) {
		return false
	}
	return true
}

func (p *MGetBookRequest) Field2DeepEqual(src []int64) bool {
...
type BookService interface {
	...
	DeleteBook(ctx context.Context, req *DeleteNoteRequest) (r *DeleteBookResponse, err error)
...
func (p *BookServiceClient) DeleteBook(ctx context.Context, req *DeleteNoteRequest) (r *DeleteBookResponse, err error) {
...
var BookServiceDeleteBookArgs_Req_DEFAULT *DeleteNoteRequest

func (p *BookServiceDeleteBookArgs) GetReq() (v *DeleteNoteRequest) {
	if !p.IsSetReq() {
		return BookServiceDeleteBookArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *BookServiceDeleteBookArgs) SetReq(val *DeleteNoteRequest) {
	p.Req = val
}
...
func (p *BookServiceDeleteBookArgs) Field1DeepEqual(src *DeleteNoteRequest) bool {
